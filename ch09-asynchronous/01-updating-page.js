//************* COMPENDIUM ********************* */
/*
You want to update the page during a long CPU - intensive operation, 
but the browser won't repaint the window while it's busy.
*/
// use setTimeout() foo periodically to queue your work.
...
document
  .getElementById("doWorkInChunks")
  .addEventListener("click", doWorkInChunks);
