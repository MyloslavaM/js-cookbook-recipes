//************* COMPENDIUM ********************* */
/*
Your foo is attempting to use the keyword this, but it's not bound to the right object
*/

// Use the Function.bind() method to change the context of your foo and the meaning of the this reference
