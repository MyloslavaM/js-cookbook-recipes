//************* COMPENDIUM ********************* */
/*
You want to create a utility method that's tied to your class, but can be called without creating an object.
*/
// Place static keyword before the method
class Book {
...
const firstPrinting = new Book(
  "978-3-16-148410-0",
  "A.I. Is Not a Threat",
  "Anne Droid",
  new Date(2010, 2, 2),
);
const secondPrinting = new Book(
  "9783161484100",
  "A.I. Is Not a Threat",
  "A. Droid",
  new Date(2011, 2, 10),
